        ...
        <>
            ...
            <Box component="form" noValidate sx={{ mt: 3 }}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        <Typography component="h4" variant="body">
                            Upload a clear photo of your Dhamma School ID:
                        </Typography>
                        <Button
                            component="label"
                            role={undefined}
                    ...
                    <Grid item xs={12}>
                        <Typography component="h4" variant="body">
                            Include a clear photo in the letter confirming the identity of the parent:
                        </Typography>
                        <Button
                            component="label"
                            role={undefined}
                    ...
                    <Grid item xs={12}>
                        <Typography component="h4" variant="body">
                            Include a clear photo of the studentship confirmation letter from the head teacher:
                        </Typography>
                        <Button
                            component="label"
                            role={undefined}
